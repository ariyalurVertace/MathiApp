...
class DropDownPicker extends React.Component {
    ...
    removeItem(value, {changeDefaultValue = true} = {}) {
        ...
        this.setPropState(
            ...
            () => this.changeDefaultValue(changeDefaultValue, value),
        );
    }

    changeDefaultValue = (changeDefaultValue, value) => {
    ...
    selectItem(defaultValue) {
        if (this.state.props.multiple) {
            (async () => {
                for (const value of defaultValue) {
                    const item = this.props.items.find(itemValue => itemValue.value === value);
                    if (item) {
                        await new Promise((resolve, reject) => {
            ...
            const item = this.props.items.find(itemValue => itemValue.value === defaultValue);
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <Text
                        style={[
                            {color: "#000", textAlign: "right"}, // default label color
                            this.props.globalTextStyle,
                            {opacity, flex: 1},
                            {
                                marginLeft:
                    ...
                    {this.props.showArrow && (
                        <View style={[styles.arrow]}>
                            <View style={[this.props.arrowStyle, {opacity}]}>
                                {!this.state.isVisible
                                    ? this.props.customArrowDown(25, this.props.arrowColor)
                                    : this.props.customArrowUp(25, this.props.arrowColor)}
                            </View>
                        </View>
                    )}
                </TouchableOpacity>
