...
class EbeatPersonModal extends React.Component {
    state = {
        selectedLocation: "",
        index: -1,
    };
        ...
        return (
            ...
            >
                <View style={styles.container}>
                    ...
                    <View style={{paddingHorizontal: 20}}>{this.renderList()}</View>
                </View>
            </Modal>
        );
    }
...
export default EbeatPersonModal;
