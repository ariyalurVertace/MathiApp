...
export default class Favorite extends Component {
  ...
  removeItemPressed(item) {
    Alert.alert(
      'Remove '+item.title,
      'Are you sure you want this item from your favorite ?',
      [
  ...
  removeItem(itemToRemove) {
    ...
    AsyncStorage.setItem("FAVORITE",JSON.stringify(items));
  }
